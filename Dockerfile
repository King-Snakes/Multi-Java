...
RUN apt-get update -y && apt-get install -y \
    ...
    for pair in \
      ...
      "16 https://github.com/adoptium/temurin16-binaries/releases/download/OpenJDK16U-jdk_aarch64_linux_hotspot_16.0.2_7/OpenJDK16U-jdk_aarch64_linux_hotspot_16.0.2_7.tar.gz" \
